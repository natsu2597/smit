...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="#menu">BBA Specialiazation</a></li>
  ...
  <!-- <section id="hero" class="hero d-flex align-items-center section-bg">
    ...
    <div class="container">
      <div class="row justify-content-between gy-5">
        ...
        <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start" style="width: 50%">
  ...
  <section id="hero" class="hero d-flex align-items-center section-bg">
    <img loading="lazy" src="assets/img/na.png" alt="nacc-a-plus Manipal University"
      ...
      style="z-index: 9;position: fixed;margin: 10px 0 0 4px;width: 64px;float:left; top: 490px;">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-5 d-flex align-items-end" data-aos="fade-up" data-aos-delay="300">
            <div class="content ps-0 ps-lg-5">
              <p class="fst-italic">
                  The aim of the department is to impart a holistic education to budding managers so that when they graduate they are not only industry and corporate ready but also life ready. BBA graduates choose from opportunities including on-campus placement, higher education and entrepreneurship. <br><br>
               SMIT is the most preferred institute for BBA as it offers several professional and industry-oriented programs. With advanced facilities, highly experience faculty, and an engaged student community, the Center of Management Studies with its world class academic practices seeks to enable the students to redefine traditional wisdom and business attitudes.
               <br><br>
               The Bachelor of Business Administration program is designed to provide competency in basic management, leadership, communication, decision making and problem solving in organisations with subjects spanning finance, marketing, human resource, information technology, operations and international trade.
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="why-box">
              <h3>Program Educational Objectives (BBA)</h3>
              <p>
               a Bachelor of Business Administration or BBA is one of the best known and most sought-after undergraduate courses for those seeking to advance their careers in management. However, following the crowd is often never the correct way of doing it. 
    ...
    <section id="menu" class="menu">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          ...
          <p><font face="Roboto" size="15px">BBA <span>SPECIALIZATION</span></font></p>
        </div>
