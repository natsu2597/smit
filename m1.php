...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <a class="btn-book-a-table" href="#book-a-table">APPLY NOW</a>
    ...
    <div class="container">
      <div class="row justify-content-between gy-5">
        <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
          <h2 data-aos="fade-up">FACULTY OF <br>MANAGEMENT</h2>
          <p data-aos="fade-up" data-aos-delay="100">Programs Approved by AICTE <br><br>
Admissions Open 2022-23</p>
          <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
            <a href="#book-a-table" class="btn-book-a-table">APPLY NOW</a>
            <a href="https://www.youtube.com/watch?v=LXb3EKWsInQ" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Watch Video</span></a>
          </div>
        </div>
        <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
          <img src="assets/img/HERO2.jpg" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="300">
        </div>
      </div>
    </div>
  </section> -->
...
<div class="lsq-form-hidden-fields">
    <input id="lsq-authKey" name="lsq-authKey" type="hidden" value="" /> 
    ...
    <input id="lsq-form-id-hidden" name="lsq-form-id-hidden" type="hidden" value="4f3f7f1e-d7a8-4534-b5e7-ea5169729e31" />
</div>
<div class="lsq-form-script-wrapper">
    <script type="text/javascript" src="https://dhx9mmhpfsala.cloudfront.net/cdn/externalforms/r21/js/lsq.form.js?v=68.2.0.2"></script>
    <script type="text/javascript">
        
        lsq_setupForm({
            id: '4f3f7f1e-d7a8-4534-b5e7-ea5169729e31' , 
            templateName: 'Text',
            themeOptions: {
                
                primaryButtonColor: '#DF582A',
                
                saveButtonText: 'Enquire Now',
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>About Us</h2>
          <p>Programme Offered <span>SMIT</span></p>
        </div>
    ...
    <section id="menu" class="menu">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>Our PROGRAMME</h2>
          <p>Check Our <span>PROGRAMME</span></p>
        </div>
        ...
        <div class="tab-content" data-aos="fade-up" data-aos-delay="300">
          ...
          <div class="tab-pane fade active show" id="menu-starters">
            ...
            <div class="row gy-5">
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets/img/menu/btech.png" class="glightbox"><img src="assets/img/menu/btech.png" class="menu-img img-fluid" alt=""></a>
                <h4>B.TECH</h4>
                <p>
          ...
          <div class="tab-pane fade" id="menu-breakfast">
            ...
            <div class="row gy-5">
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets/img/menu/mtech.jpg" class="glightbox"><img src="assets/img/menu/mtech.jpg" class="menu-img img-fluid" alt=""></a>
                <h4>M.TECH</h4>
                <p class="ingredients">
                ...
                <li><i class="bi bi-check2-all"></i> B.Tech CSE (Artificial Intelligence & Machine Learning)</li>
                <br>
M.Tech in Digital Electronics & Communication Engineering<br>
M.Tech in Power Electronics<br>
M.Tech in Structural Engineering<br>
