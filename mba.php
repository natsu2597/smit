    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="#menu">Programme Offered</a></li>
          <li><a href="#events">Facts</a></li>
    ...
    <div class="container">
      <div class="row justify-content-between gy-5">
        <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
            <h2 data-aos="fade-up"><font face="Roboto" size="15px">FACULTY<br>OF MANAGEMENT</font></h2>
        ...
        <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start" style="width: 55%">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>BBA</h2>
          <p><font face="Roboto" size="15px">CAREER <span>OPPORTUNITY</span></font></p>
        </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-5 d-flex align-items-end" data-aos="fade-up" data-aos-delay="300">
            <div class="content ps-0 ps-lg-5">
              <p class="fst-italic">
                  The aim of the department is to impart a holistic education to budding managers so that when they graduate they are not only industry and corporate ready but also life ready. MBA graduates have been successfully placed in many renound companies like HDFC Bank Ltd., BAJAJ Allianz Insurance, Lanco, IDBI Bank, Torrent  Pharma, Think and Learn, Birla Sun Life Insurance, Apollo Tyres, NEDFi, Colgate Palmolive, ICICI Bank Ltd., Axis Bank Ltd., Central Bank of India, Reliance Trend. Many have opted for Entrepreneurship.
                  <br><br>
                  The Department of Management offers MBA in Finance, HR, Marketing, Systems, Operations, Project, Quality, Banking and International Business. Emphasis is on development of an all-round managerial perspective. Students can opt for any two of the above nine specialisations. The department also conducts regular training and development programs to Govt. officers, professional managers and students.
It is a two-year course leading to the award of an MBA degree. The program has dual specialisation. Students opt for marketing and any one of the following specialisations.
            ...
            <div class="col-lg-7 position-relative about-img" style="background-image: url(assets/img/campus2.jpg) ;" data-aos="fade-up" data-aos-delay="150">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="why-box">
              <h3>Program Educational Objectives (MBA)</h3>
              <p>
               The management graduates of the department should be able to inculcate life-long learning, to solve the dynamic business problems and to enhance decision making capabilities.
The management graduates of the department should be able to communicate, solve problems, work collaboratively with the stakeholders of the organization.
The management graduates of the department should be able to perform the multi-disciplinary and challenging tasks of the corporate world with highest standards of ethics and integrity.
The management graduates of the department should be able to nurture the spirit of innovation, creativity, leadership and entrepreneurship.
            ...
            <div class="row gy-4">
              ...
              <div class="col-xl-4" data-aos="fade-up" data-aos-delay="200">
                <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                  ...
                  <h4>Vision</h4>
                  <p>To develop Department of Management Studies as a centre of excellence in management education through quality education, training, research, innovation which will eventually nurture employability and entrepreneurship.
              ...
              <div class="col-xl-4" data-aos="fade-up" data-aos-delay="300">
                <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                  <i class="bi bi-gem"></i>
                  <h4>Mission</h4>
                  <p>To bridge the gap between theory and practice in the knowledge economy.
...
To undertake research and innovation for catering to the emerging societal needs.
              ...
              <div class="col-xl-4" data-aos="fade-up" data-aos-delay="400">
                <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                  ...
                  <h4>Objectives</h4>
                  <p>To provide wholesome education to meet the intellectual aspirations of students
To equip students with techno-managerial skills to enable them to take their assigned role in the industry
To inculcate essential ethics and values to meet the spiritual needs of the students.
                  </p>
                </div>
              </div><!-- End Icon Box -->
    ...
    <section id="menu" class="menu">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          ...
          <p><font face="Roboto" size="15px">MBA <span>SPECIALIZATION</span></font></p>
        </div>
          ...
          <div class="tab-pane fade active show" id="menu-starters">
            ...
            <div class="row gy-5">
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets/img/menu/m1.png" class="glightbox"><img src="assets/img/menu/m.jpg" class="menu-img img-fluid" alt=""></a>
                <h4>Marketing</h4>
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets/img/menu/m2.jpg" class="glightbox"><img src="assets/img/menu/f.jpg" class="menu-img img-fluid" alt=""></a>
                <h4>Finance</h4>
              ...
              <div class="col-lg-4 menu-item">
                <a href="assets/img/menu/m3.jpg" class="glightbox"><img src="assets/img/menu/hr.jpg" class="menu-img img-fluid" alt=""></a>
                <h4>Human Resources</h4>
               
                
              </div><!-- Menu Item -->
               <div class="col-lg-4 menu-item">
                <a href="assets/img/menu/m3.jpg" class="glightbox"><img src="assets/img/menu/mba1.jpg" class="menu-img img-fluid" alt=""></a>
                <h4>International Business</h4>
               
                
              </div><!-- Menu Item -->
              <div class="col-lg-4 menu-item">
                <a href="assets/img/menu/m3.jpg" class="glightbox"><img src="assets/img/menu/mba2.jpg" class="menu-img img-fluid" alt=""></a>
                <h4>Operation Management</h4>
               
                
              </div><!-- Menu Item -->
              <div class="col-lg-4 menu-item">
                <a href="assets/img/menu/m3.jpg" class="glightbox"><img src="assets/img/menu/mba3.jpg" class="menu-img img-fluid" alt=""></a>
                  ...
                  <div class="col-lg-6">
                    <div class="testimonial-content">
                      <p>
                        ...
                        SMIT is like a second home to me and being in this department makes me proud. It is like a family to me, I feel so homely here.
                        
                        <i class="bi bi-quote quote-icon-right"></i>
                      </p>
                      <h3>Riddhi Debnath</h3>
                ...
                <div class="row gy-4 justify-content-center">
                  <div class="col-lg-6">
                    <div class="testimonial-content">
                      <p>
                        <i class="bi bi-quote quote-icon-left"></i>
                        SMIT's brilliant academic structure kept us occupied and helped me getting placed with Manipal Global Education Services. No regrets for the decision taken to join Sikkim Manipal University for my MBA.
                ...
                <div class="row gy-4 justify-content-center">
                  <div class="col-lg-6">
                    <div class="testimonial-content">
                      <p>
                        <i class="bi bi-quote quote-icon-left"></i>
                        My experience at SMIT was wonderful, which I will always. Faculty are excellent and took great care of us as their own child by sharing their knowledge and inspiring experiences.
                        
                        <i class="bi bi-quote quote-icon-right"></i>
                      </p>
                      <h3>Dipsikha Gogoi</h3>
